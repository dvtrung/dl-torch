...
from dlex.datasets.base.nlp import get_token_id, load_tkn_to_idx, normalize_word, normalize_char, load_idx_to_tkn
...
class CommonVoice(VoiceDataset):
    ...
    def __init__(self, mode, params):
        ...
        with open(
            ...
            self.data = [{
                'X_path': l[0],
                'Y': [word2index['<sos>']] + [int(w) for w in l[1].split(' ')] + [word2index['<eos>']],
    ...
    def collate_fn(self, batch):
        ...
        tgt = nn.utils.rnn.pad_sequence(
            ...
            padding_value=self._word2index['<eos>'])
