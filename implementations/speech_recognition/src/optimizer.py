...
class Optimizer(object):
    ...
    def __init__(self, model_parameters, **op_params):
        self.max_grad_norm = op_params['max_grad_norm']
        del op_params['max_grad_norm']
        self.optimizer = torch.optim.adam(model_parameters, **op_params)
        self.scheduler = None
