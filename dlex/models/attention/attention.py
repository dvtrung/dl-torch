...
from .decoder import DecoderRNN, DecodingStates
...
class Attention(BaseModel):
    ...
    def _build_decoder(self):
        ...
        return DecoderRNN(
            ...
            sos_id=self.dataset.sos_token_idx,
            eos_id=self.dataset.eos_token_idx,
    ...
    def forward(self, batch):
        ...
        decoder_outputs, attentions, sequences, lengths = self._decoder(encoder_outputs, encoder_output_lens, batch['Y'])
    ...
    def write_summary(self, summary_writer, batch, output):
        ...
        str_input, str_ground_truth, str_predicted = self.dataset.format_output(y_pred[0], self.dataset.get_item_from_batch(batch, 0))
